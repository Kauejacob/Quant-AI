...
| Cenário | Score Analyst | Consenso | Expected Return | Position Size |
|---------|---------------|----------|-----------------|---------------|
| **Forte Convicção** | >75 | 3 BUY | >30% | 8-10% |
| **Convicção Alta** | 66-75 | 2 BUY + 1 HOLD | 20-30% | 5-8% |
| **Convicção Moderada** | 50-66 | Misto | 10-20% | 3-5% |
| **Baixa Convicção** | 34-50 | Divergente | 5-10% | 0-3% |
| **Evitar** | <34 | Bearish | Negativo | 0% (SELL) |

**Ajustes**:
- -2% se confiança do Analyst < 0.7
- -2% se Bear_Prob > 0.7
- +2% se Bull_Prob > 0.8 E fundamentos sólidos
- -5% se liquidez baixa ou empresa pequena

### 4. Stop Loss e Take Profit

**Stop Loss:**
```
stop_loss = preço_atual × (1 - max(0.08, |downside_bear| × 0.5))
```
- Mínimo: -8% (proteção básica)
- Máximo: -25% (cenários extremos)

**Take Profit:**
```
take_profit = preço_atual × (1 + upside_bull × 0.7)
```
- Realiza 70% do upside projetado (conservador)
