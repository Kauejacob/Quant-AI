...
Uso:
    python run_backtest.py --capital 50000000 --start 2021-01-01 --end 2024-01-01
"""
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default='2022-01-01',
        help='Data início YYYY-MM-DD (padrão: 2022-01-01)'
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default='2024-01-01',
        help='Data fim YYYY-MM-DD (padrão: 2024-01-01)'
    )
